...
# ── Personality pools ─────────────────────────────────────────────────────────
INTERESTS_POOL = [
    "hiking", "cooking", "reading", "gaming", "music", "art", "film",
    "travel", "fitness", "yoga", "coding", "gardening", "photography",
    "volunteering", "dancing", "writing", "meditation", "sports",
]

TRAITS_POOL = [
    "bookworm", "romantic", "loner", "outgoing", "hot-headed", "cheerful",
    "gloomy", "creative", "ambitious", "lazy", "neat", "slob", "good",
    "evil", "materialistic", "family-oriented", "geek", "foodie",
]

DEALBREAKERS_POOL = [
    "smoking", "dishonesty", "anti-intellectualism", "aggression",
    "close-mindedness", "laziness", "rudeness",
]

ASPIRATIONS = [
    "Fortune", "Family", "Popularity", "Knowledge", "Romance", "Creative",
]

JOBS = [
    "Software Engineer", "Teacher", "Nurse", "Artist", "Chef",
    "Journalist", "Accountant", "Barista", "Freelancer", "Researcher",
]
...
INTERACTION_TYPES = {
    ...
    "romantic": ["flirt", "compliment appearance", "ask on date", "hold hands"],
...
SKILL_DEFINITIONS = {
    "charisma":  {"max": 10, "unlocks": {3: "tell riveting story", 7: "enchanting introduction"}},
    ...
    "creativity":{"max": 10, "unlocks": {2: "share artwork",       5: "perform original piece"}},
